...
<body>
        ...
        <nav class="navbar">
            <div class="nav__container container flex-row div-center">
                <a href="index.php" class="nav__logo flex-row div-center"> <img src="../../assets/avatar.jpg" alt="logo"> Foodie<span>Recipes</span></a>
                ...
                <ul class="flex-row nav__login nav__details">
                    <li class="nav__profile">
                         ...
                         <ul class="flex-column">
                             <li><a href="<?= ROOT_URL?>dashboard.php" class="nav__dash">Dashboard</a></li>
